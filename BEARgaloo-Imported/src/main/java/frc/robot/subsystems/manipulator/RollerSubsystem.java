...
public class RollerSubsystem extends SubsystemBase {
  ...
  public RollerSubsystem() {
      ...
      File directory = new File(Filesystem.getDeployDirectory(), "motors/Manipulator/Roller");
      ...
      try {
        ...
        throw new RuntimeException("Failed to configure roller motor(s): ", exception);
      }
